    ...
    <main className='py-10 space-y-16'>
        ...
        <div className="flex gap-16">
          <div className="space-y-2">
            ...
            <div className="flex gap-5 justify-center items-center">
              <a href='https://t.me/drxid' className='p-1 text-white hover:text-[#cdfbff] transition-colors'>
                <i className='w-9 h-9'>
              ...
              <a href='https://vk.com/drxid' className='p-1 text-white hover:text-[#cdfbff] transition-colors'>
                <i className='w-9 h-9'>
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-5  justify-center items-center">
              <a href='https://github.com/drxid' className='p-1 text-white hover:text-[#cdfbff] transition-colors'>
                <i className='w-9 h-9'>
                  <svg width="100%" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href='https://be.net/drxid' className='p-1 text-white hover:text-[#cdfbff] transition-colors'>
                <i className='w-9 h-6'>
      ...
      <section className='container'>
        ...
        <div className="space-y-5">
          <div className="flex gap-4">
            ...
            <div className="">
              <i className='text-[#D5D5D5] hover:text-[#f26529] transition-colors w-10 h-10'>
            ...
            <div className="">
              <i className='text-[#D5D5D5] hover:text-[#3ba4e2] transition-colors w-10 h-10'>
                <svg width="100%" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="">
              <i className='text-[#D5D5D5] hover:text-[#eccd53] transition-colors w-10 h-10'>
                <svg width="100%" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="">
              <i className='text-[#D5D5D5] hover:text-[#58ce71] transition-colors w-10 h-10'>
            ...
            <div className="">
              <i className='text-[#D5D5D5] hover:text-[#48f46d] transition-colors w-10 h-10'>
                <svg width="100%" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="">
              <i className='text-[#D5D5D5] hover:text-[#8460f1] transition-colors w-10 h-10'>
            ...
            <div className="">
              <i className='text-[#D5D5D5]  hover:text-[#6ccc5d] transition-colors w-10 h-10'>
                <svg width="100%" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="">
              <i className='text-[#D5D5D5]  hover:text-white transition-colors w-10 h-10'>
                <svg width="100%" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="">
              <i className='text-[#D5D5D5] hover:text-[#efaf65] transition-colors w-10 h-10'>
                <svg width="100%" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="inline-flex flex-wrap gap-x-3 gap-y-2">
            ...
            {keySkillsTags.map(item => (
              <div key={item} className="border-2 border-solid border-[#2F2F2F] text-[#A7A7A7] text-base py-1.5 px-3 rounded-xl">
                {item}
              </div>
            ))}
      ...
      <section className='container'>
        ...
        <article>
          ...
          <section className="">
            <h3 className='text-white text-3xl font-semibold mb-2'><span>Fullstack JS Developer</span> <span className='text-[#959595]'>in</span> <span>ООО Спектр</span></h3>
            <p className='text-[#959595] mb-5'>September 2021 — currently, <span className='text-white'>{calcDate('September 1, 2021')}</span></p>

            <div className="flex gap-16">
              <section className='space-y-10'>
                <section className="flex gap-10 mb-5">
                  <a href="https://spektrtruck.ru" className='text-[#8FE4A7] font-medium relative group'>Website <i className='absolute -right-2 top-1 w-1.5 h-1.5'>
                    <svg width="100%" className='group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform' viewBox="0 0 7 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fillRule="evenodd" clipRule="evenodd" d="M1.00001 0H6.50001V5.5H4.50001V3.41421L1.70712 6.20711L0.292908 4.79289L3.0858 2H1.00001V0Z" fill="#8FE4A7" />
                    </svg>
                  </i></a>

                  <a href="https://spektrtruck.ru" className='text-[#8FE4A7] font-medium relative group'>Design sistem presentation <i className='absolute -right-2 top-1 w-1.5 h-1.5'>
                    <svg width="100%" className='group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform' viewBox="0 0 7 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fillRule="evenodd" clipRule="evenodd" d="M1.00001 0H6.50001V5.5H4.50001V3.41421L1.70712 6.20711L0.292908 4.79289L3.0858 2H1.00001V0Z" fill="#8FE4A7" />
                    </svg>
                  </i></a>
                ...
                <section>
                  ...
                  <section className='space-y-3 max-h-52 overflow-hidden relative'>
                    <div className="group bg-gradient-to-t from-[#1A1A1A] to-transparent absolute bottom-0 right-0 w-full h-[100px] flex justify-center items-center">
              ...
              <section className='space-y-10' style={{ flex: '0 0 55%' }}>
                ...
                <div className="flex gap-10 justify-start items-start">
                  ...
                  <section className='text-xs'>
                    <h2 className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Design sistem</h2>
                    <ul className='border-l border-solid border-[#363636] pt-2 pl-2 pr-2 m-2 space-y-2'>
                      <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Company logo</li>
                      <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Corporate identity</li>
                      <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Site Design</li>
                      <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>CRM Design</li>
                      <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>News Design</li>
                    </ul>
                  </section>

                  <section className='text-xs'>
                    <h2 className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Frontend</h2>
                    <ul className='border-l border-solid border-[#363636] pt-2 pl-2 pr-2 m-2 space-y-2'>
                      <li className='w-max'>
                        <h2 className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>SPA</h2>
                        <ol className='border-l border-solid border-[#363636] pt-2 pl-2 pr-2 m-2 space-y-2'>
                          <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Vue 3</li>
                          <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Vue Router</li>
                          <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Pinia</li>
                          <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Vite</li>
                        </ol>
                      </li>
                      <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>One-page sites</li>
                      <li className='w-max'>
                        <h2 className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>CRM</h2>
                        <ol className='border-l border-solid border-[#363636] pt-2 pl-2 pr-2 m-2 space-y-2'>
                          <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Sales</li>
                          <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Service</li>
                          <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Spare parts purch.</li>
                        </ol>
                      </li>
                      <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>News (Journal)</li>
                    </ul>
                  </section>

                  <section className='text-xs'>
                    <h2 className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Backend</h2>
                    <ul className='border-l border-solid border-[#363636] pt-2 pl-2 pr-2 m-2 space-y-2'>
                      <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Express</li>
                      <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>REST API</li>
                      <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>Auth</li>
                      <li className='w-max bg-[#2B2B2B] px-3 py-1 rounded-lg'>MongoDb</li>
                    </ul>
                  </section>
